import { HashConnectConnectionState } from "../types/index.mjs";
import { RelayMessageType } from "./index.mjs";
  ...
  async onPayload(message, hc) {
    ...
    switch (message.type) {
      case RelayMessageType.ApprovePairing: {
        ...
        const approval_data = message.data;
      ...
      case RelayMessageType.Transaction: {
        ...
        const transaction_data = message.data;
      ...
      case RelayMessageType.TransactionResponse: {
        ...
        const transaction_response_data = message.data;
      ...
      case RelayMessageType.AdditionalAccountRequest: {
        ...
        const request_data = message.data;
      ...
      case RelayMessageType.AdditionalAccountResponse: {
        ...
        const response_data = message.data;
      ...
      case RelayMessageType.AuthenticationRequest: {
        ...
        const auth_request_data = message.data;
      ...
      case RelayMessageType.AuthenticationResponse: {
        ...
        const auth_response_data = message.data;
      ...
      case RelayMessageType.SigningRequest: {
        ...
        const sign_request_data = message.data;
      ...
      case RelayMessageType.SigningResponse: {
        ...
        const sign_response_data = message.data;
